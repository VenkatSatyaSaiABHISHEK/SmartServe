...
export function LoginPage() {
  ...
  const { login, waiter, waiters, listenToWaiters } = useWaiterStore();
  ...
  return (
    <div className="min-h-screen bg-[#fafafc] flex flex-col justify-between p-6 select-none font-sans relative overflow-hidden">
      ...
      {currentWaiter ? (
        ...
        /* Waiter ID Sign-In Card */
        <div className="flex-1 flex flex-col justify-center items-center py-8 z-10 max-w-md mx-auto w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-[#64748b] text-[13.5px] mt-1.5 leading-relaxed">
              Enter your assigned Waiter ID to access your personal service terminal.
            </p>
          </div>
          ...
          <form 
            ...
            className="bg-white border border-[#f1f5f9] rounded-[28px] p-6.5 shadow-sm w-full space-y-4"
          >
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-wider block ml-1">Waiter ID or Email</label>
              <input
                type="text"
                required
